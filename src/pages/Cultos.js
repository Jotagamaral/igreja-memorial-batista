...
const Cultos = () => {
  return (
    <div className="p-16 pb-0 bg-gray-100 min-h-screen">
      {/* Seção superior com duas colunas */}
      <div className='pl-4 border-l-2 border-custom-blue'>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 border-b-2 border-custom-blue">
      ...
      {/* Seção inferior com quatro colunas */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="flex flex-col items-center border-r-2 border-custom-blue ">
          <ChurchHistory 
              title="Quarta"
