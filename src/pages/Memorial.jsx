...
const Memorial = () => {
  return (
    <div
      className="bg-cover bg-center bg-no-repeat flex flex-col pt-20 px-6 md:px-10 overflow-x-hidden"
      style={{ backgroundImage: 'url(/assets/memorial_assets/Igreja-section-photo.jpg)', backgroundSize: 'cover', minHeight: '100vh' }}
    >
      <ChurchHistory 
      ...
      />
      <div className="bg-custom-blue bg-opacity-85 py-8 mt-12 md:mt-20 max-w-full md:max-w-screen-lg mx-auto rounded-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 px-4 md:px-8">
          <div>
            <ChurchHistory
              title="HISTÓRIA"
