...
const PgmPopup = ({ isMinimized, onMinimize, onMaximize, onLearnMore }) => {
  ...
  // Renderiza apenas o botão flutuante (bolinha) se estiver minimizado
  if (isMinimized) {
    return (
      <button
        onClick={onMaximize}
  ...
  // Renderiza o pop-up completo se não estiver minimizado
  return (
    <div
